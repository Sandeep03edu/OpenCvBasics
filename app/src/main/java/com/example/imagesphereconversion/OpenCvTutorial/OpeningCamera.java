...
public class OpeningCamera extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opening_camera);

        flipCamera = findViewById(R.id.open_camera_flip_camera);

        // Initializing Cameraview
        cameraBridgeViewBase = (JavaCameraView) findViewById(R.id.open_camera_camera_view);

        if (ContextCompat.checkSelfPermission((OpeningCamera.this), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(OpeningCamera.this, new String[]{Manifest.permission.CAMERA}, 0);
        } else {
            initializeCamera((JavaCameraView) cameraBridgeViewBase, activeFrontCamera);
        }
...
//        Imgproc.blur(frame, frame, new Size(3,3)); // Optional
